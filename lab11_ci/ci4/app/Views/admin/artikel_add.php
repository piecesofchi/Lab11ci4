    ...
    <div style="background: var(--card-white); padding: 30px; border-radius: 20px; box-shadow: 0 4px 12px rgba(90, 75, 83, 0.02); border: 2px solid #FFF1F1;">
        <form action="<?= base_url('/admin/artikel/add'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div style="margin-bottom: 20px;">
                ...
                <input type="text" name="judul" placeholder="Masukkan judul cerita/berita yang menarik..." 
                       ...
                       onfocus="this.style.borderColor='var(--gaming-red)'" onblur="this.style.borderColor='var(--bunny-pink)'" required autofocus>
            </div>
            ...
            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 700; margin-bottom: 8px; color: var(--text-dark); font-size: 14px;">Gambar Unggulan</label>
                <div style="display: flex; flex-direction: column; gap: 8px;">
                    <input type="file" name="gambar" id="gambar" accept="image/*" 
                           style="padding: 10px 16px; border: 2px dashed var(--bunny-pink); border-radius: 12px; background: var(--bg-soft); font-size: 13px; font-family: 'Quicksand', sans-serif; color: var(--text-dark); cursor: pointer;"
                           onchange="previewImage()">
                    <small style="color: var(--text-muted); font-size: 11px; font-weight: 500;">Format: JPG, JPEG, PNG, atau WEBP (Maksimal 2MB)</small>
                    <img class="img-preview" style="max-width: 240px; border-radius: 14px; display: none; margin-top: 10px; border: 2px solid var(--bunny-pink); box-shadow: 0 4px 10px rgba(255, 85, 85, 0.05);">
                </div>
            </div>

            <div style="margin-bottom: 20px;">
                <label style="display: block; font-weight: 700; margin-bottom: 8px; color: var(--text-dark); font-size: 14px;">Konten Cerita</label>
                <textarea name="isi" rows="12" placeholder="Tuliskan isi petualangan game atau berita di sini..." 
                          ...
                          onfocus="this.style.borderColor='var(--gaming-red)'" onblur="this.style.borderColor='var(--bunny-pink)'" required></textarea>
            </div>
            ...
            <div style="margin-bottom: 25px;">
                ...
                <select name="status" style="width: 100%; padding: 12px 16px; border: 2px solid var(--bunny-pink); border-radius: 12px; background: var(--bg-soft); font-size: 14px; font-family: 'Quicksand', sans-serif; color: var(--text-dark); outline: none; cursor: pointer; transition: border-color 0.2s;"
                    ...
                    <option value="1">🚀 Published (Terbitkan Langsung)</option>
            ...
            <div style="display: flex; align-items: center; gap: 20px; border-top: 2px dashed var(--bunny-pink); padding-top: 20px;">
                <button type="submit" class="btn-pink"
                        style="border-radius: 15px; padding: 12px 28px; font-size: 14px; font-weight: 700; background-color: var(--bunny-pink); color: var(--text-dark); transition: all 0.2s; box-shadow: 0 4px 0px #E5B2B2;"
